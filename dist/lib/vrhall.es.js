...
var rs = (d, e, t) => e in d ? os(d, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : d[e] = t;
var A = (d, e, t) => (rs(d, typeof e != "symbol" ? e + "" : e, t), t);
/*!
 * camera-controls
...
const ye = Math.PI * 2, gt = Math.PI / 2, Gt = 1e-5;
function z(d, e = Gt) {
  return Math.abs(d) < e;
}
function U(d, e, t = Gt) {
...
function Je(d, e) {
  return he(d) ? (console.warn(`${e} is not supported in OrthographicCamera`), !0) : !1;
}
function yt(d) {
...
const Xt = typeof window < "u", cs = Xt && /Mac/.test(navigator.platform), wt = !(Xt && "PointerEvent" in window), Ve = 1 / 8;
let b, Tt, Ge, et, Q, S, C, we, te, se, pe, xt, Rt, ee, Ae, Re, bt, tt, Ot, st, nt, Xe;
class Te extends as {
  /**
  ...
  constructor(e, t) {
    if (super(), this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.minDistance = 0, this.maxDistance = 1 / 0, this.infinityDolly = !1, this.minZoom = 0.01, this.maxZoom = 1 / 0, this.dampingFactor = 0.05, this.draggingDampingFactor = 0.25, this.azimuthRotateSpeed = 1, this.polarRotateSpeed = 1, this.dollySpeed = 1, this.truckSpeed = 2, this.dollyToCursor = !1, this.dragToOffset = !1, this.verticalDragToForward = !1, this.boundaryFriction = 0, this.restThreshold = 0.01, this.colliderMeshes = [], this.cancel = () => {
    ...
    }, typeof b > "u" && console.error("camera-controls: `THREE` is undefined. You must first run `CameraControls.install( { THREE: THREE } )`. Check the docs for further information."), this._camera = e, this._yAxisUpSpace = new b.Quaternion().setFromUnitVectors(this._camera.up, Ge), this._yAxisUpSpaceInverse = yt(this._yAxisUpSpace.clone()), this._state = m.NONE, this._domElement = t, this._domElement.style.touchAction = "none", this._domElement.style.userSelect = "none", this._domElement.style.webkitUserSelect = "none", this._target = new b.Vector3(), this._targetEnd = this._target.clone(), this._focalOffset = new b.Vector3(), this._focalOffsetEnd = this._focalOffset.clone(), this._spherical = new b.Spherical().setFromVector3(S.copy(this._camera.position).applyQuaternion(this._yAxisUpSpace)), this._sphericalEnd = this._spherical.clone(), this._zoom = this._camera.zoom, this._zoomEnd = this._zoom, this._nearPlaneCorners = [
      new b.Vector3(),
      new b.Vector3(),
      new b.Vector3(),
      new b.Vector3()
      ...
      middle: m.DOLLY,
      right: m.TRUCK,
      wheel: ue(this._camera) ? m.DOLLY : he(this._camera) ? m.ZOOM : m.NONE
    }, this.touches = {
      one: m.TOUCH_ROTATE,
      two: ue(this._camera) ? m.TOUCH_DOLLY_TRUCK : he(this._camera) ? m.TOUCH_ZOOM_TRUCK : m.NONE,
      three: m.TOUCH_TRUCK
    }, this._domElement) {
      const s = new b.Vector2(), n = new b.Vector2(), o = new b.Vector2(), i = (f) => {
        ...
        if (x) {
          if (x.clientX = f.clientX, x.clientY = f.clientY, x.deltaX = f.movementX, x.deltaY = f.movementY, f.pointerType === "touch")
            ...
            this._state = 0, (f.buttons & V.LEFT) === V.LEFT && (this._state = this._state | this.mouseButtons.left), (f.buttons & V.MIDDLE) === V.MIDDLE && (this._state = this._state | this.mouseButtons.middle), (f.buttons & V.RIGHT) === V.RIGHT && (this._state = this._state | this.mouseButtons.right);
          O();
        }
      }, h = (f) => {
        const R = this._findPointerById(0);
        R && (R.clientX = f.clientX, R.clientY = f.clientY, R.deltaX = f.movementX, R.deltaY = f.movementY, this._state = 0, (f.buttons & V.LEFT) === V.LEFT && (this._state = this._state | this.mouseButtons.left), (f.buttons & V.MIDDLE) === V.MIDDLE && (this._state = this._state | this.mouseButtons.middle), (f.buttons & V.RIGHT) === V.RIGHT && (this._state = this._state | this.mouseButtons.right), O());
      }, l = (f) => {
        f.cancelable && f.preventDefault(), Array.prototype.forEach.call(f.changedTouches, (R) => {
          const x = R.identifier, v = this._findPointerById(x);
          v && (v.clientX = R.clientX, v.clientY = R.clientY);
        }), O();
      }, u = (f) => {
        const R = f.pointerId, x = this._findPointerById(R);
        ...
        switch (Array.prototype.forEach.call(f.changedTouches, (R) => {
          const x = R.identifier, v = this._findPointerById(x);
          v && this._activePointers.splice(this._activePointers.indexOf(v), 1);
      ...
      const _ = (f) => {
        ...
        if (f.preventDefault(), this.dollyToCursor || this.mouseButtons.wheel === m.ROTATE || this.mouseButtons.wheel === m.TRUCK) {
          ...
          E - H < 1e3 && this._getClientRect(this._elementRect), E = H;
        }
        const R = cs ? -1 : -3, x = f.deltaMode === 1 ? f.deltaY / R : f.deltaY / (R * 10), v = this.dollyToCursor ? (f.clientX - this._elementRect.x) / this._elementRect.width * 2 - 1 : 0, N = this.dollyToCursor ? (f.clientY - this._elementRect.y) / this._elementRect.height * -2 + 1 : 0;
        switch (this.mouseButtons.wheel) {
          ...
          case m.DOLLY: {
            this._dollyInternal(-x, v, N);
            break;
          }
          case m.ZOOM: {
            this._zoomInternal(-x, v, N);
            break;
          }
        }
        ...
        if (!this._enabled)
          return;
        if ($e(this._activePointers, Q), this._getClientRect(this._elementRect), s.copy(Q), n.copy(Q), this._activePointers.length >= 2) {
          const x = Q.x - this._activePointers[1].clientX, v = Q.y - this._activePointers[1].clientY, N = Math.sqrt(x * x + v * v);
          o.set(0, N);
          const H = (this._activePointers[0].clientX + this._activePointers[1].clientX) * 0.5, $ = (this._activePointers[0].clientY + this._activePointers[1].clientY) * 0.5;
          n.set(H, $);
        }
        ...
        if (n.copy(Q), ((this._state & m.ROTATE) === m.ROTATE || (this._state & m.TOUCH_ROTATE) === m.TOUCH_ROTATE || (this._state & m.TOUCH_DOLLY_ROTATE) === m.TOUCH_DOLLY_ROTATE || (this._state & m.TOUCH_ZOOM_ROTATE) === m.TOUCH_ZOOM_ROTATE) && this._rotateInternal(R, x), (this._state & m.DOLLY) === m.DOLLY || (this._state & m.ZOOM) === m.ZOOM) {
          const v = this.dollyToCursor ? (s.x - this._elementRect.x) / this._elementRect.width * 2 - 1 : 0, N = this.dollyToCursor ? (s.y - this._elementRect.y) / this._elementRect.height * -2 + 1 : 0;
          this._state === m.DOLLY ? this._dollyInternal(x * Ve, v, N) : this._zoomInternal(x * Ve, v, N);
        }
        if ((this._state & m.TOUCH_DOLLY) === m.TOUCH_DOLLY || (this._state & m.TOUCH_ZOOM) === m.TOUCH_ZOOM || (this._state & m.TOUCH_DOLLY_TRUCK) === m.TOUCH_DOLLY_TRUCK || (this._state & m.TOUCH_ZOOM_TRUCK) === m.TOUCH_ZOOM_TRUCK || (this._state & m.TOUCH_DOLLY_OFFSET) === m.TOUCH_DOLLY_OFFSET || (this._state & m.TOUCH_ZOOM_OFFSET) === m.TOUCH_ZOOM_OFFSET || (this._state & m.TOUCH_DOLLY_ROTATE) === m.TOUCH_DOLLY_ROTATE || (this._state & m.TOUCH_ZOOM_ROTATE) === m.TOUCH_ZOOM_ROTATE) {
          const v = Q.x - this._activePointers[1].clientX, N = Q.y - this._activePointers[1].clientY, H = Math.sqrt(v * v + N * N), $ = o.y - H;
          o.set(0, H);
          const G = this.dollyToCursor ? (n.x - this._elementRect.x) / this._elementRect.width * 2 - 1 : 0, F = this.dollyToCursor ? (n.y - this._elementRect.y) / this._elementRect.height * -2 + 1 : 0;
          this._state === m.TOUCH_DOLLY || this._state === m.TOUCH_DOLLY_ROTATE || this._state === m.TOUCH_DOLLY_TRUCK || this._state === m.TOUCH_DOLLY_OFFSET ? this._dollyInternal($ * Ve, G, F) : this._zoomInternal($ * Ve, G, F);
        }
        ...
        $e(this._activePointers, Q), n.copy(Q), this._activePointers.length === 0 && (this._domElement.ownerDocument.removeEventListener("pointermove", c, { passive: !1 }), this._domElement.ownerDocument.removeEventListener("pointerup", u), this._domElement.ownerDocument.removeEventListener("touchmove", l, { passive: !1 }), this._domElement.ownerDocument.removeEventListener("touchend", y), this.dispatchEvent({ type: "controlend" }));
      };
      this._domElement.addEventListener("pointerdown", i), wt && this._domElement.addEventListener("mousedown", a), wt && this._domElement.addEventListener("touchstart", r), this._domElement.addEventListener("pointercancel", u), this._domElement.addEventListener("wheel", _, { passive: !1 }), this._domElement.addEventListener("contextmenu", g), this._removeAllEventListeners = () => {
  ...
  /**
       ...
       */
  static install(e) {
    b = e.THREE, Tt = Object.freeze(new b.Vector3(0, 0, 0)), Ge = Object.freeze(new b.Vector3(0, 1, 0)), et = Object.freeze(new b.Vector3(0, 0, 1)), Q = new b.Vector2(), S = new b.Vector3(), C = new b.Vector3(), we = new b.Vector3(), te = new b.Vector3(), se = new b.Vector3(), pe = new b.Vector3(), xt = new b.Vector3(), Rt = new b.Vector3(), ee = new b.Spherical(), Ae = new b.Spherical(), Re = new b.Box3(), bt = new b.Box3(), tt = new b.Sphere(), Ot = new b.Quaternion(), st = new b.Quaternion(), nt = new b.Matrix4(), Xe = new b.Raycaster();
  }
  /**
   * list all ACTIONs
   * @category Statics
   ...
   */
  fitToSphere(e, t) {
    const s = [], o = e instanceof b.Sphere ? tt.copy(e) : ls(e, tt);
  ...
  getDistanceToFitBox(e, t, s, n = !1) {
    if (Je(this._camera, "getDistanceToFitBox"))
      return this._spherical.radius;
  ...
  getDistanceToFitSphere(e) {
    if (Je(this._camera, "getDistanceToFitSphere"))
      return this._spherical.radius;
   ...
   */
  updateCameraUp() {
    this._yAxisUpSpace.setFromUnitVectors(this._camera.up, Ge), yt(this._yAxisUpSpaceInverse.copy(this._yAxisUpSpace));
  }
  /**
  ...
  _collisionTest() {
    let e = 1 / 0;
    if (!(this.colliderMeshes.length >= 1) || Je(this._camera, "_collisionTest"))
      return e;
    const s = S.setFromSpherical(this._spherical).divideScalar(this._spherical.radius);
    nt.lookAt(Tt, s, this._camera.up);
    for (let n = 0; n < 4; n++) {
      const o = C.copy(this._nearPlaneCorners[n]);
      o.applyMatrix4(nt);
      const i = we.addVectors(this._target, o);
      Xe.set(i, s), Xe.far = this._spherical.radius + 1;
      const a = Xe.intersectObjects(this.colliderMeshes);
...
const hs = window.THREE.AnimationClip, ds = window.THREE.Bone, us = window.THREE.Box3, it = window.THREE.BufferAttribute, ps = window.THREE.BufferGeometry, fs = window.THREE.ClampToEdgeWrapping, ge = window.THREE.Color, ms = window.THREE.DirectionalLight, _s = window.THREE.DoubleSide, Yt = window.THREE.FileLoader, gs = window.THREE.FrontSide, ot = window.THREE.Group, Es = window.THREE.ImageBitmapLoader, ys = window.THREE.InstancedMesh, ws = window.THREE.InterleavedBuffer, Ts = window.THREE.InterleavedBufferAttribute, xs = window.THREE.Interpolant, Rs = window.THREE.InterpolateDiscrete, jt = window.THREE.InterpolateLinear, bs = window.THREE.Line, Os = window.THREE.LineBasicMaterial, Ms = window.THREE.LineLoop, As = window.THREE.LineSegments, Kt = window.THREE.LinearFilter, Zt = window.THREE.LinearMipmapLinearFilter, Ss = window.THREE.LinearMipmapNearestFilter, vs = window.THREE.Loader, _e = window.THREE.LoaderUtils, rt = window.THREE.Material, Ls = window.THREE.MathUtils, qe = window.THREE.Matrix4, Ps = window.THREE.Mesh, Ie = window.THREE.MeshBasicMaterial, Ee = window.THREE.MeshPhysicalMaterial, Qt = window.THREE.MeshStandardMaterial, Cs = window.THREE.MirroredRepeatWrapping, Is = window.THREE.NearestFilter, Hs = window.THREE.NearestMipmapLinearFilter, Ds = window.THREE.NearestMipmapNearestFilter, Fs = window.THREE.NumberKeyframeTrack, qt = window.THREE.Object3D, Ns = window.THREE.OrthographicCamera, Us = window.THREE.PerspectiveCamera, zs = window.THREE.PointLight, ks = window.THREE.Points, Bs = window.THREE.PointsMaterial, Vs = window.THREE.PropertyBinding, Wt = window.THREE.Quaternion, Mt = window.THREE.QuaternionKeyframeTrack, dt = window.THREE.RepeatWrapping, Gs = window.THREE.Skeleton, Xs = window.THREE.SkinnedMesh, Ys = window.THREE.Sphere, js = window.THREE.SpotLight, At = window.THREE.Texture, Ks = window.THREE.TextureLoader, $t = window.THREE.TriangleFanDrawMode, Zs = window.THREE.TriangleStripDrawMode, Jt = window.THREE.Vector2, xe = window.THREE.Vector3, Qs = window.THREE.VectorKeyframeTrack, Ue = window.THREE.sRGBEncoding;
class qs extends vs {
  constructor(e) {
  ...
  parse(e, t, s, n) {
    ...
    if (typeof e == "string")
      ...
      if (_e.decodeText(new Uint8Array(e, 0, 4)) === es) {
        try {
          i[L.KHR_BINARY_GLTF] = new pn(e);
        } catch (h) {
          n && n(h);
          return;
        }
        o = JSON.parse(i[L.KHR_BINARY_GLTF].content);
      } else
...
class $s {
  ...
  _loadLight(e) {
    ...
    switch (r.type) {
      case "directional":
        c = new ms(h), c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      case "point":
        c = new zs(h), c.distance = l;
        break;
      case "spot":
        c = new js(h), c.distance = l, r.spot = r.spot || {}, r.spot.innerConeAngle = r.spot.innerConeAngle !== void 0 ? r.spot.innerConeAngle : 0, r.spot.outerConeAngle = r.spot.outerConeAngle !== void 0 ? r.spot.outerConeAngle : Math.PI / 4, c.angle = r.spot.outerConeAngle, c.penumbra = 1 - r.spot.innerConeAngle / r.spot.outerConeAngle, c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      default:
...
class Js {
  ...
  extendParams(e, t, s) {
    ...
    if (o) {
      ...
      o.baseColorTexture !== void 0 && n.push(s.assignTexture(e, "map", o.baseColorTexture, Ue));
    }
...
class tn {
  ...
  extendMaterialParams(e, t) {
    ...
    if (i.clearcoatFactor !== void 0 && (t.clearcoat = i.clearcoatFactor), i.clearcoatTexture !== void 0 && o.push(s.assignTexture(t, "clearcoatMap", i.clearcoatTexture)), i.clearcoatRoughnessFactor !== void 0 && (t.clearcoatRoughness = i.clearcoatRoughnessFactor), i.clearcoatRoughnessTexture !== void 0 && o.push(s.assignTexture(t, "clearcoatRoughnessMap", i.clearcoatRoughnessTexture)), i.clearcoatNormalTexture !== void 0 && (o.push(s.assignTexture(t, "clearcoatNormalMap", i.clearcoatNormalTexture)), i.clearcoatNormalTexture.scale !== void 0)) {
      ...
      t.clearcoatNormalScale = new Jt(a, a);
    }
...
class nn {
  ...
  extendMaterialParams(e, t) {
    ...
    return i.sheenColorFactor !== void 0 && t.sheenColor.fromArray(i.sheenColorFactor), i.sheenRoughnessFactor !== void 0 && (t.sheenRoughness = i.sheenRoughnessFactor), i.sheenColorTexture !== void 0 && o.push(s.assignTexture(t, "sheenColorMap", i.sheenColorTexture, Ue)), i.sheenRoughnessTexture !== void 0 && o.push(s.assignTexture(t, "sheenRoughnessMap", i.sheenRoughnessTexture)), Promise.all(o);
  }
}
class on {
  constructor(e) {
...
class cn {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.specularColor = new ge(a[0], a[1], a[2]), i.specularColorTexture !== void 0 && o.push(s.assignTexture(t, "specularColorMap", i.specularColorTexture, Ue)), Promise.all(o);
  }
}
class ln {
  constructor(e) {
...
class un {
  ...
  createNodeMesh(e) {
    ...
    return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(e)), Promise.all(a).then((c) => {
      ...
      for (const y of l) {
        const E = new qe(), _ = new xe(), g = new Wt(), w = new xe(1, 1, 1), O = new ys(y.geometry, y.material, u);
        for (let M = 0; M < u; M++)
        ...
        qt.prototype.copy.call(O, y), O.frustumCulled = !1, this.parser.assignFinalMaterial(O), p.push(O);
      }
      return h.isGroup ? (h.clear(), h.add(...p), h) : p[0];
    }));
  }
}
const es = "glTF", Se = 12, St = { JSON: 1313821514, BIN: 5130562 };
class pn {
  constructor(e) {
...
class ts extends xs {
  ...
  interpolate_(e, t, s, n) {
    ...
    for (let M = 0; M !== a; M++) {
      const f = i[E + M + a], R = i[E + M + r] * h, x = i[y + M + a], v = i[y + M] * h;
      o[M] = w * f + O * R + _ * x + g * v;
    }
    return o;
  }
...
class En extends ts {
  interpolate_(e, t, s, n) {
    ...
    return gn.fromArray(o).normalize().toArray(o), o;
  }
}
const J = {
  FLOAT: 5126,
...
function Rn(d) {
  const e = d.extensions && d.extensions[L.KHR_DRACO_MESH_COMPRESSION];
  let t;
  return e ? t = "draco:" + e.bufferView + ":" + e.indices + ":" + Pt(e.attributes) : t = d.indices + ":" + Pt(d.attributes) + ":" + d.mode, t;
}
function Pt(d) {
  let e = "";
...
class Mn {
  constructor(e = {}, t = {}) {
    this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new Ws(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.meshCache = { refs: {}, uses: {} }, this.cameraCache = { refs: {}, uses: {} }, this.lightCache = { refs: {}, uses: {} }, this.sourceCache = {}, this.textureCache = {}, this.nodeNamesUsed = {};
    let s = !1, n = !1, o = -1;
    typeof navigator < "u" && (s = /^((?!chrome|android).)*safari/i.test(navigator.userAgent) === !0, n = navigator.userAgent.indexOf("Firefox") > -1, o = n ? navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1] : -1), typeof createImageBitmap > "u" || s || n && o < 98 ? this.textureLoader = new Ks(this.options.manager) : this.textureLoader = new Es(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Yt(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
  }
  setExtensions(e) {
    this.extensions = e;
  }
  ...
  parse(e, t) {
    ...
    this.cache.removeAll(), this._invokeAll(function(i) {
      ...
      ve(o, a, n), de(a, n), Promise.all(s._invokeAll(function(r) {
  ...
  loadAccessor(e) {
    ...
    if (n.bufferView === void 0 && n.sparse === void 0) {
      const i = at[n.type], a = be[n.componentType], r = n.normalized === !0, c = new a(n.count * i);
      return Promise.resolve(new it(c, i, r));
    }
    const o = [];
    return n.bufferView !== void 0 ? o.push(this.getDependency("bufferView", n.bufferView)) : o.push(null), n.sparse !== void 0 && (o.push(this.getDependency("bufferView", n.sparse.indices.bufferView)), o.push(this.getDependency("bufferView", n.sparse.values.bufferView))), Promise.all(o).then(function(i) {
      const a = i[0], r = at[n.type], c = be[n.componentType], h = c.BYTES_PER_ELEMENT, l = h * r, u = n.byteOffset || 0, p = n.bufferView !== void 0 ? s.bufferViews[n.bufferView].byteStride : void 0, y = n.normalized === !0;
      let E, _;
      if (p && p !== l) {
        const g = Math.floor(u / p), w = "InterleavedBuffer:" + n.bufferView + ":" + n.componentType + ":" + g + ":" + n.count;
        let O = t.cache.get(w);
        O || (E = new c(a, g * p, n.count * p / h), O = new ws(E, p / h), t.cache.add(w, O)), _ = new Ts(O, r, u % p / h, y);
      } else
        a === null ? E = new c(n.count * r) : E = new c(a, u, n.count * r), _ = new it(E, r, y);
      if (n.sparse !== void 0) {
        const g = at.SCALAR, w = be[n.sparse.indices.componentType], O = n.sparse.indices.byteOffset || 0, M = n.sparse.values.byteOffset || 0, f = new w(i[1], O, n.sparse.count * g), R = new c(i[2], M, n.sparse.count * r);
        a !== null && (_ = new it(_.array.slice(), _.itemSize, _.normalized));
  ...
  loadTextureImage(e, t, s) {
    ...
    const c = this.loadImageSource(t, s).then(function(h) {
      ...
      return h.magFilter = vt[u.magFilter] || Kt, h.minFilter = vt[u.minFilter] || Zt, h.wrapS = Lt[u.wrapS] || dt, h.wrapT = Lt[u.wrapT] || dt, n.associations.set(h, { textures: e }), h;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(e, t) {
    ...
    const h = Promise.resolve(r).then(function(l) {
      ...
      return c === !0 && a.revokeObjectURL(r), l.userData.mimeType = i.mimeType || bn(i.uri), l;
    }).catch(function(l) {
  ...
  assignTexture(e, t, s, n) {
    ...
    return this.getDependency("texture", s.index).then(function(i) {
      if (!i)
        return null;
      if (s.texCoord !== void 0 && s.texCoord != 0 && !(t === "aoMap" && s.texCoord == 1) && console.warn("THREE.GLTFLoader: Custom UV set " + s.texCoord + " for texture " + t + " not yet supported."), o.extensions[L.KHR_TEXTURE_TRANSFORM]) {
        const a = s.extensions !== void 0 ? s.extensions[L.KHR_TEXTURE_TRANSFORM] : void 0;
        if (a) {
          const r = o.associations.get(i);
          i = o.extensions[L.KHR_TEXTURE_TRANSFORM].extendTexture(i, a), o.associations.set(i, r);
        }
      }
  ...
  assignFinalMaterial(e) {
    ...
    if (e.isPoints) {
      ...
      r || (r = new Bs(), rt.prototype.copy.call(r, s), r.color.copy(s.color), r.map = s.map, r.sizeAttenuation = !1, this.cache.add(a, r)), s = r;
    } else if (e.isLine) {
      const a = "LineBasicMaterial:" + s.uuid;
      let r = this.cache.get(a);
      r || (r = new Os(), rt.prototype.copy.call(r, s), r.color.copy(s.color), this.cache.add(a, r)), s = r;
    }
    if (n || o || i) {
  ...
  loadMaterial(e) {
    ...
    if (r[L.KHR_MATERIALS_UNLIT]) {
      const l = n[L.KHR_MATERIALS_UNLIT];
      ...
      l.baseColorTexture !== void 0 && c.push(t.assignTexture(a, "map", l.baseColorTexture, Ue)), a.metalness = l.metallicFactor !== void 0 ? l.metallicFactor : 1, a.roughness = l.roughnessFactor !== void 0 ? l.roughnessFactor : 1, l.metallicRoughnessTexture !== void 0 && (c.push(t.assignTexture(a, "metalnessMap", l.metallicRoughnessTexture)), c.push(t.assignTexture(a, "roughnessMap", l.metallicRoughnessTexture))), i = this._invokeOne(function(u) {
    ...
    o.doubleSided === !0 && (a.side = _s);
    const h = o.alphaMode || ct.OPAQUE;
    if (h === ct.BLEND ? (a.transparent = !0, a.depthWrite = !1) : (a.transparent = !1, h === ct.MASK && (a.alphaTest = o.alphaCutoff !== void 0 ? o.alphaCutoff : 0.5)), o.normalTexture !== void 0 && i !== Ie && (c.push(t.assignTexture(a, "normalMap", o.normalTexture)), a.normalScale = new Jt(1, 1), o.normalTexture.scale !== void 0)) {
      const l = o.normalTexture.scale;
      a.normalScale.set(l, l);
    }
    return o.occlusionTexture !== void 0 && i !== Ie && (c.push(t.assignTexture(a, "aoMap", o.occlusionTexture)), o.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = o.occlusionTexture.strength)), o.emissiveFactor !== void 0 && i !== Ie && (a.emissive = new ge().fromArray(o.emissiveFactor)), o.emissiveTexture !== void 0 && i !== Ie && c.push(t.assignTexture(a, "emissiveMap", o.emissiveTexture, Ue)), Promise.all(c).then(function() {
      const l = new i(a);
      return o.name && (l.name = o.name), de(l, o), t.associations.set(l, { materials: e }), o.extensions && ve(n, l, o), l;
    });
  }
  /** When Object3D instances are targeted by animation, they need unique names. */
  createUniqueName(e) {
    const t = Vs.sanitizeNodeName(e || "");
    let s = t;
  ...
  loadGeometries(e) {
    ...
    for (let a = 0, r = e.length; a < r; a++) {
      const c = e[a], h = Rn(c), l = n[h];
      if (l)
        i.push(l.promise);
      else {
        let u;
        c.extensions && c.extensions[L.KHR_DRACO_MESH_COMPRESSION] ? u = o(c) : u = Ct(new ps(), c, t), n[h] = { primitive: c, promise: u }, i.push(u);
      }
    }
  ...
  loadMesh(e) {
    ...
    for (let r = 0, c = i.length; r < c; r++) {
      const h = i[r].material === void 0 ? wn(this.cache) : this.getDependency("material", i[r].material);
      a.push(h);
    }
    return a.push(t.loadGeometries(i)), Promise.all(a).then(function(r) {
      ...
      for (let p = 0, y = h.length; p < y; p++) {
        ...
        if (_.mode === J.TRIANGLES || _.mode === J.TRIANGLE_STRIP || _.mode === J.TRIANGLE_FAN || _.mode === void 0)
          g = o.isSkinnedMesh === !0 ? new Xs(E, w) : new Ps(E, w), g.isSkinnedMesh === !0 && !g.geometry.attributes.skinWeight.normalized && g.normalizeSkinWeights(), _.mode === J.TRIANGLE_STRIP ? g.geometry = It(g.geometry, Zs) : _.mode === J.TRIANGLE_FAN && (g.geometry = It(g.geometry, $t));
        ...
        Object.keys(g.geometry.morphAttributes).length > 0 && xn(g, o), g.name = t.createUniqueName(o.name || "mesh_" + e), de(g, o), _.extensions && ve(n, g, _), t.assignFinalMaterial(g), l.push(g);
      }
  ...
  loadCamera(e) {
    ...
    return s.type === "perspective" ? t = new Us(Ls.radToDeg(n.yfov), n.aspectRatio || 1, n.znear || 1, n.zfar || 2e6) : s.type === "orthographic" && (t = new Ns(-n.xmag, n.xmag, n.ymag, -n.ymag, n.znear, n.zfar)), s.name && (t.name = this.createUniqueName(s.name)), de(t, s), Promise.resolve(t);
  }
  /**
  ...
  loadAnimation(e) {
    ...
    return Promise.all([
      ...
      for (let g = 0, w = h.length; g < w; g++) {
        ...
        const N = O.name ? O.name : O.uuid, H = R.interpolation !== void 0 ? yn[R.interpolation] : jt, $ = [];
        ae[x.path] === ae.weights ? O.traverse(function(F) {
          F.morphTargetInfluences && $.push(F.name ? F.name : F.uuid);
        }) : $.push(N);
        let G = f.array;
        if (f.normalized) {
          const F = pt(G.constructor), Y = new Float32Array(G.length);
          for (let B = 0, oe = G.length; B < oe; B++)
            Y[B] = G[B] * F;
          G = Y;
        }
        for (let F = 0, Y = $.length; F < Y; F++) {
          const B = new v(
            $[F] + "." + ae[x.path],
            M.array,
            G,
          ...
          R.interpolation === "CUBICSPLINE" && (B.createInterpolant = function(j) {
            const re = this instanceof Mt ? En : ts;
  ...
  loadNode(e) {
    ...
    return function() {
      ...
      let l;
      if (o.isBone === !0 ? l = new ds() : r.length > 1 ? l = new ot() : r.length === 1 ? l = r[0] : l = new qt(), l !== r[0])
        for (let u = 0, p = r.length; u < p; u++)
          l.add(r[u]);
      if (o.name && (l.userData.name = o.name, l.name = i), de(l, o), o.extensions && ve(s, l, o), o.matrix !== void 0) {
        const u = new qe();
   ...
   */
  loadScene(e) {
    const t = this.extensions, s = this.json.scenes[e], n = this, o = new ot();
    s.name && (o.name = n.createUniqueName(s.name)), de(o, s), s.extensions && ve(t, o, s);
    const i = s.nodes || [], a = [];
    for (let r = 0, c = i.length; r < c; r++)
    ...
    return Promise.all(a).then(function(r) {
      ...
      const c = (h) => {
        ...
        for (const [u, p] of n.associations)
          (u instanceof rt || u instanceof At) && l.set(u, p);
        return h.traverse((u) => {
...
function Ct(d, e, t) {
  ...
  return de(d, e), An(d, e, t), Promise.all(n).then(function() {
    return e.targets !== void 0 ? Tn(d, e.targets, t) : d;
  });
}
function It(d, e) {
  let t = d.getIndex();
...
const K = window.THREE.BoxGeometry, Ht = window.THREE.BufferGeometry, q = window.THREE.CylinderGeometry, Sn = window.THREE.DoubleSide, vn = window.THREE.Euler, Dt = window.THREE.Float32BufferAttribute, ce = window.THREE.Line, Ln = window.THREE.LineBasicMaterial, ss = window.THREE.Matrix4, T = window.THREE.Mesh, ns = window.THREE.MeshBasicMaterial, ft = window.THREE.Object3D, Ye = window.THREE.OctahedronGeometry, Pn = window.THREE.PlaneGeometry, ie = window.THREE.Quaternion, Cn = window.THREE.Raycaster, In = window.THREE.SphereGeometry, Le = window.THREE.TorusGeometry, P = window.THREE.Vector3, fe = new Cn(), W = new P(), le = new P(), k = new ie(), Ft = {
  X: new P(1, 0, 0),
  Y: new P(0, 1, 0),
  Z: new P(0, 0, 1)
}, lt = { type: "change" }, Nt = { type: "mouseDown" }, Ut = { type: "mouseUp", mode: null }, zt = { type: "objectChange" };
class Hn extends ft {
  constructor(e, t) {
    ...
    function i(w, O) {
      ...
      Object.defineProperty(o, w, {
        ...
        set: function(f) {
          M !== f && (M = f, n[w] = f, s[w] = f, o.dispatchEvent({ type: w + "-changed", value: f }), o.dispatchEvent(lt));
        }
      }), o[w] = O, n[w] = O, s[w] = O;
    }
    ...
    if (i) {
      if (this.pointEnd.copy(i.point).sub(this.worldPositionStart), s === "translate")
        ...
        if (t.search("XYZ") !== -1) {
          ...
          W.copy(this.pointStart), le.copy(this.pointEnd), W.applyQuaternion(this._worldQuaternionInv), le.applyQuaternion(this._worldQuaternionInv), le.divide(W), t.search("X") === -1 && (le.x = 1), t.search("Y") === -1 && (le.y = 1), t.search("Z") === -1 && (le.z = 1);
        ...
        t === "E" ? (this.rotationAxis.copy(this.eye), this.rotationAngle = this.pointEnd.angleTo(this.pointStart), this._startNorm.copy(this.pointStart).normalize(), this._endNorm.copy(this.pointEnd).normalize(), this.rotationAngle *= this._endNorm.cross(this._startNorm).dot(this.eye) < 0 ? 1 : -1) : t === "XYZE" ? (this.rotationAxis.copy(this._offset).cross(this.eye).normalize(), this.rotationAngle = this._offset.dot(W.copy(this.rotationAxis).cross(this.eye)) * a) : (t === "X" || t === "Y" || t === "Z") && (this.rotationAxis.copy(Ft[t]), W.copy(Ft[t]), o === "local" && W.applyQuaternion(this.worldQuaternion), this.rotationAngle = this._offset.dot(W.cross(this.eye).normalize()) * a), this.rotationSnap && (this.rotationAngle = Math.round(this.rotationAngle / this.rotationSnap) * this.rotationSnap), o === "local" && t !== "E" && t !== "XYZE" ? (n.quaternion.copy(this._quaternionStart), n.quaternion.multiply(k.setFromAxisAngle(this.rotationAxis, this.rotationAngle)).normalize()) : (this.rotationAxis.applyQuaternion(this._parentQuaternionInv), n.quaternion.copy(k.setFromAxisAngle(this.rotationAxis, this.rotationAngle)), n.quaternion.multiply(this._quaternionStart).normalize());
      }
      this.dispatchEvent(lt), this.dispatchEvent(zt);
    }
  }
  pointerUp(e) {
    e.button === 0 && (this.dragging && this.axis !== null && (Ut.mode = this.mode, this.dispatchEvent(Ut)), this.dragging = !1, this.axis = null);
  }
  dispose() {
  ...
  reset() {
    this.enabled && this.dragging && (this.object.position.copy(this._positionStart), this.object.quaternion.copy(this._quaternionStart), this.object.scale.copy(this._scaleStart), this.dispatchEvent(lt), this.dispatchEvent(zt), this.pointStart.copy(this.pointEnd));
  }
  getRaycaster() {
    return fe;
  }
...
const je = new vn(), D = new P(0, 1, 0), kt = new P(0, 0, 0), Bt = new ss(), Ke = new ie(), Qe = new ie(), ne = new P(), Vt = new ss(), He = new P(1, 0, 0), me = new P(0, 1, 0), De = new P(0, 0, 1), Ze = new P(), Pe = new P(), Ce = new P();
class kn extends ft {
  constructor() {
    ...
    const g = new Ht();
    g.setAttribute("position", new Dt([0, 0, 0, 1, 0, 0], 3));
    const w = new q(75e-4, 75e-4, 0.5, 3);
    w.translate(0, 0.25, 0);
    function O(B, oe) {
      const j = new Le(B, 75e-4, 3, 64, oe * Math.PI * 2);
      return j.rotateY(Math.PI / 2), j.rotateX(Math.PI / 2), j;
    }
    function M() {
      const B = new Ht();
      return B.setAttribute("position", new Dt([0, 0, 0, 1, 1, 1], 3)), B;
    }
    const f = {
      X: [
      ...
      XYZE: [
        [new T(new In(0.25, 10, 8), s)]
      ],
      X: [
        [new T(new Le(0.5, 0.1, 4, 24), s), [0, 0, 0], [0, -Math.PI / 2, -Math.PI / 2]]
      ],
      Y: [
        [new T(new Le(0.5, 0.1, 4, 24), s), [0, 0, 0], [Math.PI / 2, 0, 0]]
      ],
      Z: [
        [new T(new Le(0.5, 0.1, 4, 24), s), [0, 0, 0], [0, 0, -Math.PI / 2]]
      ],
      E: [
        [new T(new Le(0.75, 0.1, 2, 24), s)]
      ]
    }, $ = {
      X: [
    ...
    function Y(B) {
      ...
      for (const j in B)
        for (let re = B[j].length; re--; ) {
          const Z = B[j][re][0].clone(), ze = B[j][re][1], ke = B[j][re][2], Be = B[j][re][3], is = B[j][re][4];
          Z.name = j, Z.tag = is, ze && Z.position.set(ze[0], ze[1], ze[2]), ke && Z.rotation.set(ke[0], ke[1], ke[2]), Be && Z.scale.set(Be[0], Be[1], Be[2]), Z.updateMatrix();
          const _t = Z.geometry.clone();
          _t.applyMatrix4(Z.matrix), Z.geometry = _t, Z.renderOrder = 1 / 0, Z.position.set(0, 0, 0), Z.rotation.set(0, 0, 0), Z.scale.set(1, 1, 1), oe.add(Z);
        }
      return oe;
    }
    this.gizmo = {}, this.picker = {}, this.helper = {}, this.add(this.gizmo.translate = Y(f)), this.add(this.gizmo.rotate = Y(v)), this.add(this.gizmo.scale = Y($)), this.add(this.picker.translate = Y(R)), this.add(this.picker.rotate = Y(H)), this.add(this.picker.scale = Y(G)), this.add(this.helper.translate = Y(x)), this.add(this.helper.rotate = Y(N)), this.add(this.helper.scale = Y(F)), this.picker.translate.visible = !1, this.picker.rotate.visible = !1, this.picker.scale.visible = !1;
  }
  // updateMatrixWorld will update transformations and appearance of individual handles
  updateMatrixWorld(e) {
    const s = (this.mode === "scale" ? "local" : this.space) === "local" ? this.worldQuaternion : Qe;
    ...
    for (let o = 0; o < n.length; o++) {
      ...
      if (this.camera.isOrthographicCamera ? a = (this.camera.top - this.camera.bottom) / this.camera.zoom : a = this.worldPosition.distanceTo(this.cameraPosition) * Math.min(1.9 * Math.tan(Math.PI * this.camera.fov / 360) / this.camera.zoom, 7), i.scale.set(1, 1, 1).multiplyScalar(a * this.size / 4), i.tag === "helper") {
        i.visible = !1, i.name === "AXIS" ? (i.visible = !!this.axis, this.axis === "X" && (k.setFromEuler(je.set(0, 0, 0)), i.quaternion.copy(s).multiply(k), Math.abs(D.copy(He).applyQuaternion(s).dot(this.eye)) > 0.9 && (i.visible = !1)), this.axis === "Y" && (k.setFromEuler(je.set(0, 0, Math.PI / 2)), i.quaternion.copy(s).multiply(k), Math.abs(D.copy(me).applyQuaternion(s).dot(this.eye)) > 0.9 && (i.visible = !1)), this.axis === "Z" && (k.setFromEuler(je.set(0, Math.PI / 2, 0)), i.quaternion.copy(s).multiply(k), Math.abs(D.copy(De).applyQuaternion(s).dot(this.eye)) > 0.9 && (i.visible = !1)), this.axis === "XYZE" && (k.setFromEuler(je.set(0, Math.PI / 2, 0)), D.copy(this.rotationAxis), i.quaternion.setFromRotationMatrix(Bt.lookAt(kt, D, me)), i.quaternion.multiply(k), i.visible = this.dragging), this.axis === "E" && (i.visible = !1)) : i.name === "START" ? (i.position.copy(this.worldPositionStart), i.visible = this.dragging) : i.name === "END" ? (i.position.copy(this.worldPosition), i.visible = this.dragging) : i.name === "DELTA" ? (i.position.copy(this.worldPositionStart), i.quaternion.copy(this.worldQuaternionStart), W.set(1e-10, 1e-10, 1e-10).add(this.worldPositionStart).sub(this.worldPosition).multiplyScalar(-1), W.applyQuaternion(this.worldQuaternionStart.clone().invert()), i.scale.copy(W), i.visible = this.dragging) : (i.quaternion.copy(s), this.dragging ? i.position.copy(this.worldPositionStart) : i.position.copy(this.worldPosition), this.axis && (i.visible = this.axis.search(i.name) !== -1));
        continue;
      }
      i.quaternion.copy(s), this.mode === "translate" || this.mode === "scale" ? (i.name === "X" && Math.abs(D.copy(He).applyQuaternion(s).dot(this.eye)) > 0.99 && (i.scale.set(1e-10, 1e-10, 1e-10), i.visible = !1), i.name === "Y" && Math.abs(D.copy(me).applyQuaternion(s).dot(this.eye)) > 0.99 && (i.scale.set(1e-10, 1e-10, 1e-10), i.visible = !1), i.name === "Z" && Math.abs(D.copy(De).applyQuaternion(s).dot(this.eye)) > 0.99 && (i.scale.set(1e-10, 1e-10, 1e-10), i.visible = !1), i.name === "XY" && Math.abs(D.copy(De).applyQuaternion(s).dot(this.eye)) < 0.2 && (i.scale.set(1e-10, 1e-10, 1e-10), i.visible = !1), i.name === "YZ" && Math.abs(D.copy(He).applyQuaternion(s).dot(this.eye)) < 0.2 && (i.scale.set(1e-10, 1e-10, 1e-10), i.visible = !1), i.name === "XZ" && Math.abs(D.copy(me).applyQuaternion(s).dot(this.eye)) < 0.2 && (i.scale.set(1e-10, 1e-10, 1e-10), i.visible = !1)) : this.mode === "rotate" && (Ke.copy(s), D.copy(this.eye).applyQuaternion(k.copy(s).invert()), i.name.search("E") !== -1 && i.quaternion.setFromRotationMatrix(Bt.lookAt(this.eye, kt, me)), i.name === "X" && (k.setFromAxisAngle(He, Math.atan2(-D.y, D.z)), k.multiplyQuaternions(Ke, k), i.quaternion.copy(k)), i.name === "Y" && (k.setFromAxisAngle(me, Math.atan2(D.x, D.z)), k.multiplyQuaternions(Ke, k), i.quaternion.copy(k)), i.name === "Z" && (k.setFromAxisAngle(De, Math.atan2(D.y, D.x)), k.multiplyQuaternions(Ke, k), i.quaternion.copy(k))), i.visible = i.visible && (i.name.indexOf("X") === -1 || this.showX), i.visible = i.visible && (i.name.indexOf("Y") === -1 || this.showY), i.visible = i.visible && (i.name.indexOf("Z") === -1 || this.showZ), i.visible = i.visible && (i.name.indexOf("E") === -1 || this.showX && this.showY && this.showZ), i.material._color = i.material._color || i.material.color.clone(), i.material._opacity = i.material._opacity || i.material.opacity, i.material.color.copy(i.material._color), i.material.opacity = i.material._opacity, this.enabled && this.axis && (i.name === this.axis || this.axis.split("").some(function(r) {
        return i.name === r;
...
class Bn extends T {
  constructor() {
    super(
      new Pn(1e5, 1e5, 2, 2),
      new ns({ visible: !1, wireframe: !0, side: Sn, transparent: !0, opacity: 0.1, toneMapped: !1 })
    ), this.isTransformControlsPlane = !0, this.type = "TransformControlsPlane";
  }
  updateMatrixWorld(e) {
    let t = this.space;
    switch (this.position.copy(this.worldPosition), this.mode === "scale" && (t = "local"), Ze.copy(He).applyQuaternion(t === "local" ? this.worldQuaternion : Qe), Pe.copy(me).applyQuaternion(t === "local" ? this.worldQuaternion : Qe), Ce.copy(De).applyQuaternion(t === "local" ? this.worldQuaternion : Qe), D.copy(Pe), this.mode) {
      case "translate":
      case "scale":
        switch (this.axis) {
          case "X":
            D.copy(this.eye).cross(Ze), ne.copy(Ze).cross(D);
            break;
          case "Y":
            D.copy(this.eye).cross(Pe), ne.copy(Pe).cross(D);
            break;
          case "Z":
            D.copy(this.eye).cross(Ce), ne.copy(Ce).cross(D);
            break;
          case "XY":
            ne.copy(Ce);
            break;
    ...
    ne.length() === 0 ? this.quaternion.copy(this.cameraQuaternion) : (Vt.lookAt(W.set(0, 0, 0), ne, D), this.quaternion.setFromRotationMatrix(Vt)), super.updateMatrixWorld(e);
  }
}
const X = window.THREE, mt = class extends X.Mesh {
  constructor(t, s) {
    super(t);
    A(this, "isReflector");
    A(this, "camera");
    ...
    A(this, "dispose");
    this.isReflector = !0, this.type = "Reflector", this.camera = new X.PerspectiveCamera();
    const n = this, o = s.color !== void 0 ? new X.Color(s.color) : new X.Color(8355711), i = s.textureWidth || 512, a = s.opacity || 1, r = s.textureHeight || 512, c = s.clipBias || 0, h = s.shader || mt.ReflectorShader, l = s.multisample !== void 0 ? s.multisample : 4, u = new X.Plane(), p = new X.Vector3(), y = new X.Vector3(), E = new X.Vector3(), _ = new X.Matrix4(), g = new X.Vector3(0, 0, -1), w = new X.Vector4(), O = new X.Vector3(), M = new X.Vector3(), f = new X.Vector4(), R = new X.Matrix4(), x = this.camera, v = new X.WebGLRenderTarget(
      i,
      r,
      {
        samples: l
      }
    ), N = new X.ShaderMaterial({
      uniforms: UniformsUtils.clone(h.uniforms),
      fragmentShader: h.fragmentShader,
      vertexShader: h.vertexShader
    });
    N.uniforms.tDiffuse.value = v.texture, N.uniforms.color.value = o, N.uniforms.textureMatrix.value = R, N.uniforms.opacity.value = a, this.material = N, this.onBeforeRender = function(H, $, G) {
      if (y.setFromMatrixPosition(n.matrixWorld), E.setFromMatrixPosition(G.matrixWorld), _.extractRotation(n.matrixWorld), p.set(0, 0, 1), p.applyMatrix4(_), O.subVectors(y, E), O.dot(p) > 0)
        return;
      O.reflect(p).negate(), O.add(y), _.extractRotation(G.matrixWorld), g.set(0, 0, -1), g.applyMatrix4(_), g.add(E), M.subVectors(y, g), M.reflect(p).negate(), M.add(y), x.position.copy(O), x.up.set(0, 1, 0), x.up.applyMatrix4(_), x.up.reflect(p), x.lookAt(M), x.far = G.far, x.updateMatrixWorld(), x.projectionMatrix.copy(G.projectionMatrix), R.set(
        0.5,
        0,
        0,
        0.5,
      ...
      const F = x.projectionMatrix;
      f.x = (Math.sign(w.x) + F.elements[8]) / F.elements[0], f.y = (Math.sign(w.y) + F.elements[9]) / F.elements[5], f.z = -1, f.w = (1 + F.elements[10]) / F.elements[14], w.multiplyScalar(2 / w.dot(f)), F.elements[2] = w.x, F.elements[6] = w.y, F.elements[10] = w.z + 1 - c, F.elements[14] = w.w, v.texture.encoding = H.outputEncoding, n.visible = !1;
      const Y = H.getRenderTarget(), B = H.xr.enabled, oe = H.shadowMap.autoUpdate;
      H.xr.enabled = !1, H.shadowMap.autoUpdate = !1, H.setRenderTarget(v), H.state.buffers.depth.setMask(!0), H.autoClear === !1 && H.clear(), H.render($, x), H.xr.enabled = B, H.shadowMap.autoUpdate = oe, H.setRenderTarget(Y);
      const j = G.viewport;
      j !== void 0 && H.state.viewport(j), n.visible = !0;
    }, this.getRenderTarget = function() {
      return v;
    }, this.dispose = function() {
      v.dispose(), n.material.dispose();
    };
  }
};
let Fe = mt;
...
class Xn {
  ...
  destroy() {
    this._orienter = null, this._controls = null;
  }
}
const We = class {
  static createButton(e) {
    ...
    function s() {
      let r = null;
      async function c(l) {
        l.addEventListener("end", h), await e.xr.setSession(l), t.textContent = "EXIT VR", r = l;
      }
      function h() {
        r.removeEventListener("end", h), t.textContent = "ENTER VR", r = null;
      }
      t.style.display = "", t.style.cursor = "pointer", t.style.left = "calc(50% - 50px)", t.style.width = "100px", t.textContent = "ENTER VR", t.onmouseenter = function() {
        ...
        if (r === null) {
          const l = { optionalFeatures: ["local-floor", "bounded-floor", "hand-tracking", "layers"] };
          navigator.xr.requestSession("immersive-vr", l).then(c);
        } else
          r.end();
      };
    }
    ...
    function o() {
      n(), t.textContent = "VR NOT SUPPORTED";
    }
    function i(r) {
      n(), console.warn("Exception when trying to call xr.isSessionSupported", r), t.textContent = "VR NOT ALLOWED";
    }
    function a(r) {
    ...
    if ("xr" in navigator)
      return t.id = "VRButton", t.style.display = "none", a(t), navigator.xr.isSessionSupported("immersive-vr").then(function(r) {
        r ? s() : o(), r && We.xrSessionIsGranted && t.click();
      }).catch(i), t;
    {
  ...
  static registerSessionGrantedListener() {
    if ("xr" in navigator) {
      ...
      navigator.xr.addEventListener("sessiongranted", () => {
        We.xrSessionIsGranted = !0;
      });
    }
  }
};
let Ne = We;
A(Ne, "xrSessionIsGranted", !1);
Ne.registerSessionGrantedListener();
...
class jn {
  constructor(e) {
    ...
    A(this, "_EPS", 1e-5);
    // gltf加载器
    A(this, "_gltfLoader", new qs());
    // 屏幕射线
    A(this, "_raycaster", new I.Raycaster());
    // 展厅模型
    ...
    // 加载器
    A(this, "_textLoader", new I.TextureLoader());
    // 事件元素
    A(this, "_eventMeshs", []);
    // 控制器
    ...
    // 重力感应实例
    A(this, "gravity", null);
    A(this, "initVRButton", (e = document.body) => {
      this._renderer.xr.enabled = !0, this._renderer.xr.setReferenceSpaceType("local"), e.appendChild(Ne.createButton(this._renderer));
    });
    ...
    }), this._animate(), window.addEventListener("resize", this._resize.bind(this)), this._options.debugger && (this._initTransformControls(), this._scene.add(new I.AxesHelper(1e3))), this.gravity = new Xn(this._controls);
  }
  addAnimate(e) {
  ...
  // 镜面反射
  _reflectorPlane() {
    const t = new I.PlaneBufferGeometry(1e3, 1e3), s = new Fe(t, {
      opacity: 0.1,
      textureWidth: 1e3,
      textureHeight: 1e3,
      color: "#fff"
    });
    s.material.side = I.DoubleSide, s.material.transparent = !0, s.material.opacity = 0.1, s.rotation.x = -Math.PI / 2, s.position.y = this._planeMesh.position.y + 0.1, this._scene.add(s);
  }
  /**
   * 初始化
   */
  _init() {
    ...
    this._scene = new I.Scene(), this._camera = new I.PerspectiveCamera(70, e / t, 0.1, 1e4), this._scene.add(this._camera), this._scene.add(new I.AmbientLight(16777215, 1));
    const s = new I.DirectionalLight(16777215, 0.7);
    s.position.set(5, 5, 5), this._scene.add(s), this._controls = new Te(
      this._camera,
  ...
  _initTransformControls() {
    this._transformControls = new Hn(
      this._camera,
      this._renderer.domElement
   ...
   */
  _resize() {
    this._size.width = this._options.container.clientWidth, this._size.height = this._options.container.clientHeight, this._renderer.setSize(this._size.width, this._size.height), this._camera.aspect = this._size.width / this._size.height, this._camera.updateProjectionMatrix();
  }
  createAnimate(e, { animateIndex: t, duration: s } = { animateIndex: 0, duration: 10 }) {
    const n = new I.AnimationMixer(e.scene), o = e.animations[t];
    return n.clipAction(o).setDuration(s).play(), n.update(0), this.addAnimate((a) => {
      n.update(a);
    }), n;
  }
  // 查看作品
  ...
  moveTo(e, t, s) {
    ...
    const n = new I.Vector3(e.x, e.y, e.z);
    n.lerp(new I.Vector3(t.x, t.y, t.z), this._EPS);
    const o = new I.Vector3(), i = new I.Vector3();
    this._controls.getPosition(o), this._controls.getTarget(i), new I.Vector3(e.x, e.y, e.z).lerp(new I.Vector3(t.x, t.y, t.z), this._EPS), this._controls.setLookAt(
      e.x,
      e.y,
      e.z,
      n.x,
  ...
  _getBoxRaycaster({ x: e, y: t }, s) {
    ...
    this._mouse = new I.Vector2(), this._mouse.set(
      e / n.clientWidth * 2 - 1,
  ...
  async _lookat() {
    if (!this._options.cameraOption)
      return;
    const { position: e, lookAt: t } = this._options.cameraOption, s = new I.Vector3(e.x, e.y, e.z);
    s.lerp(new I.Vector3(t.x, t.y, t.z), this._EPS), this._controls.zoomTo(0.8), await this._controls.setLookAt(
      e.x,
      e.y,
      e.z,
      s.x,
  ...
  _mouseUp(e) {
    const { top: t, left: s } = Vn(this._options.container), { x: n, y: o } = this._events.startXY, i = 2;
  ...
  loadGLTF(e) {
    return new Promise((t) => {
      ...
      this._gltfLoader.load(
        s,
        (h) => {
          const l = h.scene, u = new I.Box3().setFromObject(l).getSize(new I.Vector3());
          console.log("box模型大小", s, u, l), c && h.scene.traverse((p) => {
            p.isMesh && (p.castShadow = !0, p.material.emissive = p.material.color, p.material.emissiveMap = p.material.map);
          }), l.scale.set(o, o, o), n && (l.position.y = n.y, l.position.x = n.x, l.position.z = n.z), i && (l.rotation.y = i.y, l.rotation.x = i.x, l.rotation.z = i.z), this._scene.add(l), r && (l.animations = r), t(h);
        },
        (h) => {
          a && a(h);
        },
   ...
   */
  async loadHall(e) {
    return this._hallPlaneName = e.planeName, await this.loadGLTF({ ...e }).then((t) => (this._hallMesh = t.scene, t.scene.traverse((s) => {
      s.name === e.planeName && (this._planeMesh = s);
    }), t));
  }
  /**
   * 载入展品数据
  ...
  loadItems(e) {
    ...
    e.forEach(async (s) => {
      ...
      const o = new I.BoxGeometry(
        s.width,
        s.height,
        s.depth ? s.depth : 2
      ), i = new I.MeshBasicMaterial({
  ...
  destroy() {
    this._options.container.removeEventListener(
      ...
      "mouseup",
      this._mouseUp.bind(this)
    ), window.removeEventListener("resize", this._resize.bind(this)), this.gravity = null, this.gravity.destroy(), this._renderer.dispose(), this._options = null, this._renderer = null, this._camera = null, this._scene = null, this._clock = null, this._controls = null, cancelAnimationFrame(this._requestAnimate), this._requestAnimate = null, this._gltfLoader = null, this._raycaster = null, this._hallMesh = null, this._planeMesh = null, this._textLoader = null, this._eventMeshs = null, this._transfromControls = null, this._events = null, this._itemsData = null, this._animates = null;
  }
}
export {
  jn as default
